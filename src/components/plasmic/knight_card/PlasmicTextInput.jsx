...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 4wLcyqNzLC-ld/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: EGl89KBr_WWEqw/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg___19NEk)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xpVrF)}
                role={"img"}
              />
            ),
